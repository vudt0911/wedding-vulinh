<template>
	<div class="w-full rounded-2xl bg-stone-400 p-10 dark:bg-stone-200">
		...
		<div class="flex flex-col items-center justify-center gap-y-3 lg:gap-y-5">
			<p class="font-serif text-sm text-gray-200 dark:text-slate-600 md:text-base">Vị trí sự kiện</p>
			<p class="font-serif text-sm text-gray-200 dark:text-slate-600 md:text-base">{{local}}</p>
		</div>
		<div class="mt-8">
			<a class="btn" :href="mapLocal" target="_blank" rel="noopener noreferrer" title="Lihat Maps">
...
<script setup lang="ts">
    ...
    mapLocal: { type: String, required: true },
