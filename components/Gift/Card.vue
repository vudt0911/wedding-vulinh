...
<script setup lang="ts">
	const copy = async (text: string) => {
		...
		btnGift.setAttribute('title', 'Đã sao chép thành công');
		btnGiftText.innerHTML = 'Đã sao chép thành công';

		setTimeout(() => {
			btnGift.setAttribute('title', 'Copy');
			btnGiftText.innerHTML = 'Copy';
		}, 3000);
	};
</script>
